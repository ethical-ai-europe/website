...
**When government uses AI, the stakes are higher.** Citizens can't choose a different provider. Public services affect fundamental rights. And public trust—once broken—is hard to rebuild.
...
AI systems that predict criminal behavior based solely on profiling, personality traits, or residence—without reference to objective, verifiable facts linked to criminal activity.
...
- Exit strategy—what happens if you switch vendors?
...
For high-risk public sector AI, human oversight isn't optional—it's mandatory. Here's how to implement it effectively:
...
### 🟢 Good Practice: Transparent Benefits Processing
...
### 🔴 Problem Case: Opaque Fraud Detection
...
### 🟢 Good Practice: Public Registry for Police AI
...
### 🔴 Problem Case: Educational AI Without Consent
...
✅ **Public sector AI faces higher standards**—rightly so

✅ **Know the prohibitions**—some AI uses are completely banned

✅ **Apply the framework**—necessity, proportionality, transparency, accountability, redress

✅ **Require compliance from vendors**—don't accept vague assurances

✅ **Register high-risk systems**—it's required, and it builds trust

✅ **Implement real human oversight**—not just rubber-stamping

✅ **Communicate proactively**—citizens deserve to know

✅ **Learn from failures**—other agencies' mistakes can be your warnings

---

*Need the detailed compliance checklist? [Go to the AI Compliance Checklist →](/en/for-organizations/compliance-checklist)*

*For organizational guidance: [Return to For Organizations →](/en/for-organizations)*
