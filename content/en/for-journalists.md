...
This guide helps you navigate the AI landscape in Europe—understand the regulatory framework, find story angles, access reliable sources, and connect with experts.
...
AI touches every sector—work, education, healthcare, public services. Real people are affected by these systems every day.
...
#### EU AI Act Overview
The essentials of Europe's AI regulation—what it covers, how it works, and why it matters globally.
...
A plain-language guide to AI rights under European law—the right to know, the right to explanation, the right to human review, and the right to object.

[Your AI Rights →](/en/rights)

#### What Can People Do?
Practical guidance on how individuals can exercise their rights—from template letters to complaint processes.
...
*Stories about compliance—or non-compliance—become increasingly relevant as each deadline approaches.*
...
### Share Stories
Have you documented cases where AI affected people's lives? We want to hear from you—your reporting can inform our resources and help others.
...
**AI systems are increasingly making decisions that affect millions of people—often with little transparency or accountability.** When algorithms determine who gets hired, who gets benefits, who gets surveilled, or who gets opportunities, the public deserves to know how these decisions are made.
...
The EU AI Act creates new transparency requirements and new rights for individuals. But rights only matter if people know they exist—and if they're enforced.
